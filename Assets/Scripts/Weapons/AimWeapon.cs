...
public class AimWeapon : MonoBehaviour
{
    ...
    private void Aim(AimDirection aimDirection, float aimAngle)
    {
        ...
        weaponRotationPointTransform.eulerAngles = new Vector3(0f, 0f, aimAngle);//将武器旋转点的旋转角度设置为鼠标角度
        ...
        switch (aimDirection)
        {
            ...
            case AimDirection.UpLeft:
                weaponRotationPointTransform.localScale = new Vector3(1f, -1f, 0f);//朝向为左时，将武器旋转点翻转到另一边
                break;
