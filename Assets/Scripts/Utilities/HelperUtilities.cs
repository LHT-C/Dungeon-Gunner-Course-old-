...
public static class HelperUtilities
{
    ...
    /// </summary>
    /// <returns></returns>
    public static Vector3 GetDirectionVectorFromAngle(float angle)//根据角度计算方向矢量
    {
    ...
    /// </summary>
    public static bool ValidateCheckPositiveValue(Object thisObject, string fieldName, int valueToCheck, bool isZeroAllowed)//检测位置值的方法（是否允许为0）
    {
        bool error = false;
